...
local f_path = from_entry.path
from_entry.path = function(entry, validate, escape)
    ...
    preview = {
      ...
      filetype_hook = function(filepath, bufnr, opts)
        if vim.startswith(filepath, "jdt://") then
          require("hon6.lsp.utils.jdtls").open_jdt_link(filepath, bufnr, opts.preview.timeout)
        end
        return true
      end,
    },
